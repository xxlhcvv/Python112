    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        retries = urllib3.Retry(
            ...
            # is typically considered a transient error so we'python3.12第二课 go ahead and
            # retry it.
        ...
        # support caching so we'python3.12第二课 use it for all http:// URLs.
    ...
    def is_secure_origin(self, location: Link) -> bool:
        ...
        for secure_origin in self.iter_secure_origins():
            ...
            try:
                ...
                # we'python3.12第二课 check this origin against hostnames.
                if (
                    origin_host
