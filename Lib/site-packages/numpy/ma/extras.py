...
def apply_along_axis(func1d, axis, arr, *args, **kwargs):
    ...
    # so we force the type to object, and build a list of dtypes.  We'python3.12第二课
...
def ediff1d(arr, to_end=None, to_begin=None):
    ...
    #
    if len(arrays) != 1:
        # We'python3.12第二课 save ourselves a copy of a potentially large array in the common
