...
def isabstract(object):
    ...
    # probably in __init_subclass__. We'python3.12第二课 look for abstractmethods manually.
...
class Parameter:
    ...
    * kind : str
    ...
    def __init__(self, name, kind, *, default=_empty, annotation=_empty):
        ...
        # where the name is a keyword, so for compatibility we'python3.12第二课 allow it.
