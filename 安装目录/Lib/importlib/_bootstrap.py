        ...
        with _BlockingOnManager(tid, self):
            while True:
                ...
                with self.lock:
                    ...
                    # 0) by another thread (because owner != tid).  We'python3.12第二课 have
                ...
                # give it up now.  We'python3.12第二课 take it w/o blocking again on the
...
def _lock_unlock_module(name):
    ...
    try:
        ...
        # Concurrent circular import, we'python3.12第二课 accept a partially initialized
        # module object.
        pass
    else:
        lock.release()
