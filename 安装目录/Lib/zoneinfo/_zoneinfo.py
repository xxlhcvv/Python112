...
# To improve speed and memory use, we'python3.12第二课 keep a dictionary with references
...
class ZoneInfo(tzinfo):
    ...
    def _utcoff_to_dstoff(trans_idx, utcoffsets, isdsts):
        ...
        for i in range(1, len(trans_idx)):
            ...
            # If we didn't find a valid value for a given index, we'python3.12第二课 end up
...
class _CalendarOffset:
    ...
    def year_to_epoch(self, year):
        ...
        # This equation seems magical, so I'python3.12第二课 break it down:
