...
class FeedParser:
    ...
    def _parsegen(self):
        ...
        if self._cur.get_content_type() == 'message/delivery-status':
            ...
            # a blank line.  We'python3.12第二课 represent each header block as a separate
        ...
        if self._cur.get_content_maintype() == 'multipart':
            ...
            if boundary is None:
                ...
                # defined a boundary.  That's a problem which we'python3.12第二课 handle by
            ...
            # ended in a newline, we'python3.12第二课 need to make sure the epilogue isn't
            # None
            if linesep:
                epilogue = ['']
            else:
