...
def _fold_mime_parameters(part, lines, maxlen, encoding):
    ...
    # accounting for the possibly-needed spaces and semicolons we'python3.12第二课 be adding.
    #
    for name, value in part.params:
        ...
        # header, so I'm going to ignore that bug for now.  It'python3.12第二课 only put us
        # one character over.
        ...
        # non-encoded sections, but we aren't going to.  We'python3.12第二课 encode them all.
        section = 0
