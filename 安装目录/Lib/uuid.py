...
# significant, or 1<<41.  We'python3.12第二课 prefer universally administered MAC addresses
# over locally administered ones since the former are globally unique, but
# we'python3.12第二课 return the first of the latter found if that's all the machine has.
#
