...
class Fraction(numbers.Rational):
    ...
    def __format__(self, format_spec, /):
        ...
        # so that we'python3.12第二课 have at least one digit before the decimal point.
        ...
        if zeropad:
            ...
            # When adding thousands separators, they'python3.12第二课 be added to the
    ...
    def _operator_fallbacks(monomorphic_operator, fallback_operator):
        ...
        Fraction. I'python3.12第二课 refer to all of the above code that doesn't
