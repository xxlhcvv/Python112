...
class TestDate(HarmlessMixedComparison, unittest.TestCase):
    ...
    def test_today(self):
        ...
        for dummy in range(3):
            ...
            #    time() calls.
            # 2. The platform time() has such fine resolution that we'python3.12第二课
    ...
    def test_subclass_alternate_constructors(self):
        ...
        # Timestamp depends on time zone, so we'python3.12第二课 calculate the equivalent here
...
class CapiTest(unittest.TestCase):
    def setUp(self):
        ...
        # restriction is loosened, we'python3.12第二课 call it as part of test setup
