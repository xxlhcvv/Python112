...
class Decimal(object):
    ...
    def as_integer_ratio(self):
        ...
        # we'python3.12第二课 deal with the sign later.
        n = int(self._int)
        if self._exp >= 0:
            # self is an integer.
    ...
    def exp(self, context=None):
        ...
        # raise Rounded and Inexact here---they'python3.12第二课 always be raised as
...
def _dexp(c, e, p):
    ...
    # we'python3.12第二课 call iexp with M = 10**(p+2), giving p+3 digits of precision
    p += 2
